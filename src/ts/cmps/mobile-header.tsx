...
export function MobileHeader() {
    return (
        <header className='full mobile-header'>
            <nav>
                <NavLink to='/' className='explore-wrapper'>
                    <svg
                        viewBox='0 0 32 32'
                ...
                <NavLink to='/wishlist' className='wishlist-wrapper'>
                    <svg
                        viewBox='0 0 32 32'
                        xmlns='http://www.w3.org/2000/svg'
                        aria-hidden='true'
                ...
                <NavLink to='/trips' className='trips-wrapper'>
                    <svg
                        viewBox='0 0 32 32'
                        xmlns='http://www.w3.org/2000/svg'
                        aria-hidden='true'
